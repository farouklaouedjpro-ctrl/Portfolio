// ═══════════════════════════════════════════════════════════
// 1. DATA (inline fallback - data.json loaded when available)
// ═══════════════════════════════════════════════════════════
const FALLBACK_DATA = {
  basics: {
    name: "Farouk LAOUEDJ",
    ...
    lead: "Expert en devenir des SI, je bâtis des solutions numériques où l'IA et l'automatisation rencontrent la stratégie métier. J'aime gérer des projets IT complexes, analyser des données et développer des modèles d'intelligence artificielle pour transformer vos processus.",
  ...
  projects: [
    ...
    },
    {
      ...
      status: "En cours",
      description: "Je pilote le développement d'un média multi-plateforme (Instagram, TikTok) dédié à la veille technologique, où je transforme une stratégie de curation de données en un écosystème digital cohérent, de l'automatisation des flux à la conception de la future plateforme web.",
    ...
    },
    {
      ...
      status: "En cours",
      description: "Expert en Data Visualisation sous Power BI, j'accompagne les entreprises dans la transformation de leurs données complexes en tableaux de bord interactifs et décisionnels, facilitant ainsi le pilotage de la performance et la réactivité opérationnelle.",
...
async function init() {
  try {
    ...
    console.warn("Failed to load data.json — using inline fallback");
    DATA = FALLBACK_DATA;
  }
